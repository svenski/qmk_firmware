...
RGUI(KC_Z), RGUI(KC_X), RGUI(KC_C), RGUI(KC_V), RGUI(KC_B),               KC_SLASH, KC_1, KC_2, KC_3, KC_DOT, 
	...
	[2] = LAYOUT(
            ...
            LSFT(KC_GRAVE), KC_HASH, KC_QUESTION, KC_UNDS, KC_EXLM,                KC_CIRC, KC_LPRN, KC_DOLLAR, KC_RPRN, KC_COLON,
            LSFT(KC_GRAVE), KC_NO, LSFT(KC_NONUS_BSLASH), KC_SLSH, KC_NONUS_BSLASH,                LSFT(KC_8), KC_LCBR, KC_MINS, KC_RCBR, LSFT(KC_2),
