...
LGUI_T(KC_Z), KC_X, KC_C, KC_V, KC_B,                KC_K, KC_M, KC_COMM, KC_DOT, LGUI_T(KC_QUOT),
	...
	[1] = LAYOUT(
KC_NO, RGUI(KC_W), RGUI(LSFT(KC_LEFT)), RGUI(LSFT(KC_RGHT)), RGUI(KC_G),               LSFT(KC_8), KC_7, KC_8, KC_9,  KC_PEQL,
...
RGUI(KC_Z), RGUI(KC_X), RGUI(KC_C), RGUI(KC_V), RGUI(KC_B),               KC_SLASH, KC_1, KC_2, KC_3, KC_DOT, 
	...
	[2] = LAYOUT(
            ...
            KC_NO, KC_NO, LSFT(KC_NONUS_BSLASH), KC_SLSH, KC_NONUS_BSLASH,                KC_DQUO, KC_LCBR, KC_MINS, KC_RCBR, LSFT(KC_2),
	...
	[3] = LAYOUT(KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,       KC_F6, KC_F7, KC_F8, KC_F9, KC_F10,
            ...
            KC_MSTP, KC_MPLY, KC_VOLD, KC_PSCREEN, RESET, KC_TRNS, KC_END, KC_TRNS, KC_TRNS, KC_TRNS, TG(6), KC_TRNS, LGUI(LALT(KC_BSPACE)), KC_TRNS, KC_TRNS, KC_TRNS),
 ...
 [5] = LAYOUT(KC_TRANS,KC_TRANS,KC_TRANS,KC_TRANS,KC_TRANS,      LCTL(LALT(KC_LEFT)),LALT(KC_7),LALT(KC_8),LALT(KC_9),LSFT(LCTL(LALT(KC_LEFT))),
         KC_TRANS,KC_TRANS,KC_KP_MINUS,KC_TAB,KC_SLASH,    LCTL(LALT(KC_H)),LALT(KC_4),LALT(KC_5),LALT(KC_6),LALT(KC_L),
